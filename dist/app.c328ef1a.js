...
var results = $('#results'),
    list = $('#list');
var getExerciseBtn = $('#getExerciseBtn'),
    addItemBtn = $('#addItemBtn'),
    clearItemsBtn = $('#clearItemsBtn'),
    hideListBtn = $('#hideListBtn');
var addItemInput = $('#addItemInput');
var exercises = [],
    listArr = [];
assembleArrays(); // Triggers
...
hideListBtn.click(hideList); // Functions: 
...
function addItem() {
  if (addItemInput.val()) {
    list.append("<li>".concat(addItemInput.val(), "</li>"));
    addItemInput.val('');
    assembleArrays();
  }
}
...
function getExercise() {
  var randomNum = Math.floor(Math.random() * exercises.length);
